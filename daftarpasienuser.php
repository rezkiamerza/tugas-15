...
?>
	<div class="container">
  <h2> <CENTER>Daftar pasien</h2></CENTER>
            <br>
            <br>  
  ...
  <tbody><?php do { ?>
      <tr>
        <td><?php echo $rekord['NoRM'];?></td>
         <td><?php echo $rekord['NoIdPasien'];?></td>
        <td><?php echo $rekord['JenisId'];?></td>
        <td><?php echo $rekord['NamaPasien'];?></td>
        <td><?php echo $rekord['Alamat'];?></td>
        <td><?php echo $rekord['Agama'];?></td>
         <td><?php echo $rekord['GolonganDarah'];?></td>
        <td><?php echo $rekord['TanggalLahir'];?></td>
        <td><?php echo $rekord['JenisKelamin'];?></td>
        <td><?php echo $rekord['WaktuDaftar'];?></td>
