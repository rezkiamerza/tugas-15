...
<br>
<div class="container">
	<h1><center>Hapus Daftar Ruangan Terpakai Pasien</center></h1><br><br>
	<form method="post">
		<div class="form-grup">
			<input type="text" class="form-control" name="hapus" id="hapus" placeholder="Masukan No Ruangan Pasien Sebagai Kunci">
		</div><br>
...
<?php if (isset($_POST['bhapus'])) {
	...
	$sql="DELETE FROM `layananruang` WHERE `layananruang`.`NomorRuang` = '".$pasiendihapus."'";
	$q=$koneksi->query($sql);
	if ($q) {
		echo "<center><h2>Ruangan Pasien sudah dihapus !</center></h2>";
	} else {
		echo "<center><h2>Ruangan Pasien gagal dihapus !</center></h2>";
	}
}
?>
<br>
